...
class Reviews1Screen extends StatefulWidget {


  final MainModel mainModel;
  Reviews1Screen({required this.mainModel});



  @override
  _Reviews1ScreenState createState() => _Reviews1ScreenState();
}

class _Reviews1ScreenState extends State<Reviews1Screen>  with TickerProviderStateMixin{
  ...
  _init() async {
    ...
    _waits(true);
     var ret = await loadReviewsForServiceScreen(widget.mainModel.currentService.id);
        ...
        child: Stack(
          children: <Widget>[
            ...
            Container(
              ...
              margin: EdgeInsets.only(top: MediaQuery.of(context).padding.top+30, left: 10, right: 10),
              child: ListView(
                children: _getList(),
              ),
            ),
