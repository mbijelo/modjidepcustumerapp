...
class _BookNow3ScreenState extends State<BookNow3Screen> {
  ...
  saveDat () async{
    dprint("lancement de l'enreg1");
  String _desc = "";
    dprint("lancement de l'enreg2");
  if (price.name.isNotEmpty)
    dprint("lancement de l'enreg3");
  _desc = getTextByLocale(price.name, strings.locale);
    dprint("lancement de l'enreg4");
  double _amount = getTotal();
    dprint("lancement de l'enreg5");
  _mainModel.cartUser = false;
    dprint("lancement de l'enreg6");
  paymentProcess(_amount, _desc, _waits, context, _book2, _mainModel);
    dprint("lancement de l'enreg7");
  }
          ...
          children: [
            ...
            Container(
              ...
              margin: EdgeInsets.only(
                  left: windowWidth/4, right: windowWidth/4, top: windowHeight/1.5, bottom: windowHeight/4),
            ...
            Container(
              width: windowWidth/2 ,
              margin: EdgeInsets.only(
                  left: windowWidth/4, right: windowWidth/4, top: 0, bottom: windowHeight/2.5),
              padding: EdgeInsets.only(
                  left: 0, right: 0, top: 5, bottom: 5),
              ...
              //alignment: Alignment.bottomCenter,
              alignment: Alignment.bottomCenter,
              child: button2(strings.get(246), /// "Cancel"
                  //theme.mainColor,
                  Colors.black54,
                      (){
                    //goBack();
  ...
  _book2(){
    ...
    */
    ...
    _mainModel.openDialog("succesBooking");
  }
  ...
  _body(){
    ...
    list.add(Container(
        ...
        child: Row(
          children: [
            Expanded(child: Text("", // Text(strings.get(77), // "Total",
