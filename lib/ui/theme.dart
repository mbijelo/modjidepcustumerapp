...
class AppTheme implements DefaultTheme{
  ...
  AppTheme(bool _dartMode, {
    ...
    style16W800 = TextStyle(fontFamily: _font, letterSpacing: 0.6,
        fontSize: 15, fontWeight: FontWeight.w800, color: (darkMode) ? Colors.white : Colors.black);

    stylee16W800 = TextStyle(fontFamily: _font, letterSpacing: 0.6,
        fontSize: 11, fontWeight: FontWeight.w800, color: (darkMode) ? Colors.white : Colors.black);

    style16W400U = TextStyle(fontFamily: _font, letterSpacing: 0.2,
  ...
  TextStyle style10W600GreyWhite = TextStyle(fontFamily: _font, letterSpacing: 0.6,
      fontSize: 10, fontWeight: FontWeight.w600, color: Colors.white);


  TextStyle style10W600Grey1 = TextStyle(fontFamily: _font, letterSpacing: 0.6,
      fontSize: 14.0, fontWeight: FontWeight.bold, color: Colors.black);

  TextStyle style10W600Grey11 = TextStyle(fontFamily: _font, letterSpacing: 0.6,
      fontSize: 13.0,  fontWeight: FontWeight.w400, color: Colors.black);

  TextStyle style10W600White11 = TextStyle(fontFamily: _font, letterSpacing: 0.6,
      fontSize: 13.0,  fontWeight: FontWeight.w400, color: Colors.white);

  TextStyle style10W600Grey111 = TextStyle(fontFamily: _font, letterSpacing: 0.6,
      fontSize: 10,  fontWeight: FontWeight.w400, color: Colors.black);

  TextStyle style10W600Grey1112 = TextStyle(fontFamily: _font, letterSpacing: 0,
      fontSize: 12,  fontWeight: FontWeight.w500, color: Colors.black);

  TextStyle style10W600Grey11120 = TextStyle(fontFamily: _font, letterSpacing: 0,
  ...
  TextStyle style16W600White = TextStyle(fontFamily: _font, letterSpacing: 0.6,
  ...
  TextStyle style18W800GreyNotif = TextStyle(fontFamily: _font, letterSpacing: 0,
      fontSize: 16, fontWeight: FontWeight.w800, color: Colors.grey);
