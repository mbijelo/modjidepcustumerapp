...
import 'package:ondemandservice/ui/indicator.dart';
...
import 'dialogs/succes_booking.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null && (_state == "home" || _state == "booking" || _state == "cart" || _state == "notify" || _state == "account"))
      _state = "login";
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        if (((_state == "home" || _state == "indicator" || _state == "book3" || _state == "category") && !_mainModel.searchActivate)
          || _state == "booking" || _state == "cart" || _state == "notify" || _state == "account" || _state == "offdate"){
          _dialogName = "exit";
          _show = 1;
          _redraw();
          return false;
  ...
  Widget _getDialogBody(){
    ...
    if(trouve) {
      ...
      if (dialogName == "noInternet")
        return getErrorInternet(() {
          _show = 0;
          _redraw();
        }, _mainModel, _editControllerAddress, _editControllerName,
            _editControllerPhone, context);
      ...
      if (dialogName == "noInternet1")
        return getErrorInternet1(() {
          _show = 0;
          _redraw();
        }, _mainModel, _editControllerAddress, _editControllerName,
            _editControllerPhone, context);
      ...
      if (dialogName == "succesBooking")
        return getSuccesBooking(() {
          _show = 0;
          _redraw();
        }, _mainModel, _editControllerAddress, _editControllerName,
            _editControllerPhone, context);
