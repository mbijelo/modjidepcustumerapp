...
getErrorInternet(Function() _close, MainModel _mainModel, TextEditingController _editControllerAddress,
    ...
    return Column(
      ...
      children: [
        ...
        Center(child: Text(strings.get(292), /// "Add the location",
        ...
        Row(
          children: [
            Expanded(//child: button2ww(strings.get(206), /// "Save location",
                child: button2ww(//strings.get(113), /// "Save location",
                    strings.get(291), /// "Save location",
                //theme.mainColor,
                Colors.red,
...
getErrorInternet1(Function() _close, MainModel _mainModel, TextEditingController _editControllerAddress,
    TextEditingController _editControllerName, TextEditingController _editControllerPhone, BuildContext context){
  _editControllerAddress.text = _editControllerName.text;
  _mainModel.account.initAddressEdit(_editControllerAddress, _editControllerName, _editControllerPhone);
  ...
  return Column(
    ...
    children: [
      ...
      Row(
        children: [
          Expanded(//child: button2ww(strings.get(206), /// "Save location",
              child: text != "" ? button2ww(//strings.get(113), /// "Save location",
                  strings.get(291), /// "Save location",
                  //theme.mainColor,
                  Colors.red,
...
getError1(Function() _close, MainModel _mainModel, BuildContext context, text){
...
getMessageAfterOtpWell(Function() _close, MainModel _mainModel, BuildContext context, text){
