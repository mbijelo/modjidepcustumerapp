  ...
  addAddressByCurrentPosition() async {
    ...
    if (x) {
      ...
      try {
        ...
        dprint("oui oui et oui 2");
      }catch(e){
        dprint("pas de connection internet");
          parent.openDialog("noInternet");
          route("category");

      }

    }else{
      dprint("non non et non");
      route("category");
    }
  }
